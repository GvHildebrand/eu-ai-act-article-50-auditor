...
The full reasoning behind the auditor, moved here from the README on 2026-09-16 so the README can stay short. Nothing was cut. Start with the [README](../README.md) if you only want to run it.
